...
static const YYINT yysindex[] = {                      -257,
 -263, -254, -258, -248, -252,    0,    0, -257,    0, -246,
    0, -245,    0, -239, -243,    0,    0,    0,    0, -242,
    0,    0,    0,    0,    0, -251,    0,    0,
};
...
static const YYINT yytable[] = {                          1,
    2,   10,    3,    4,   11,   27,   15,    5,   28,   12,
   20,   13,   16,   17,   18,   19,   22,   24,   12,   25,
   16,   26,    1,   21,   23,
};
static const YYINT yycheck[] = {                        257,
  258,  265,  260,  261,  259,  257,  265,  265,  260,  264,
  263,  266,  261,  262,  263,  264,  263,  257,  264,  263,
    0,  264,  257,    8,   12,
};
#define YYFINAL 6
#ifndef YYDEBUG
...
#line 51 "./query_grammar.y"
	{ populate_library_list(yystack.l_mark[-1].strlist); }
break;
case 12:
